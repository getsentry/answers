...
For more tips on working with Django on Sentry, have a look at these articles:
 ...
 - [Monitoring Performance and Errors in a Django Application with Sentry](https://blog.sentry.io/2022/05/19/monitoring-performance-and-errors-in-a-django-application-with-sentry#create-a-django-project)
 - [Finding and Fixing Django N+1 Problems](https://blog.sentry.io/2020/09/14/finding-and-fixing-django-n-1-problems)
 - [Debug Issues Faster with Breadcrumbs](https://blog.sentry.io/2016/05/04/breadcrumbs#python)
